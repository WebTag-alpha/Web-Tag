...
export default function Home() {
  return (
    <div className="bg-gradient-to-r h-[calc(100vh-120px)] from-indigo-50 to-purple-50  dark:from-gray-900 dark:to-gray-800 py-12 md:py-20 animate-fadeIn">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white mb-4">
              Your{" "}
              <span className="text-indigo-600 dark:text-indigo-400">Web3</span>{" "}
              Identity
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              A decentralized alternative to Linktree for Web3 users. Create a
              verified on-chain profile with customizable links to social media,
              NFT collections, wallets, and more.
            </p>
